...
def generate_13_methods(low_img):
    ...
    gamma_values = np.linspace(0.5, 1.9, 2)  # 0.5, 0.85, 1.2, 1.55, 1.9
    ...
    # 13. HE
    img_combined = ContrastImprover.HE(low_img)
    specs.append((img_combined, "HE", {}))
...
def main():
    ...
    parser.add_argument("--output", type=str, default="best_methods(huge_ssim_6)2.jsonl")
    parser.add_argument("--ext", type=str, default=".png")
    parser.add_argument("--start_num", type=int, default=701)
