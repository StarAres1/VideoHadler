...
def main():
    ...
    parser.add_argument("--output", type=str, default="best_methods2.jsonl")
    parser.add_argument("--ext", type=str, default=".png")
    parser.add_argument("--start_num", type=int, default=701)
    parser.add_argument("--end_num", type=int, default=None)
    parser.add_argument("--w_ssim", type=float, default=0.3, help="Вес SSIM (0..1)")
    parser.add_argument("--w_rms", type=float, default=0.7, help="Вес RMS-контраста (0..1)")
